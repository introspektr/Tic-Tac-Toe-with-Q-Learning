...
def main() -> None:
    ...
    eval_parser.add_argument("--opponent", type=str, choices=["random", "rule-based", "human"], default="random", 
                           help="Type of opponent to play against ('random', 'rule-based', or 'human')")
